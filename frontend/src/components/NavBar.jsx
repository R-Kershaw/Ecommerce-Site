...
export default function NavBar() {
    //don't destructure for a primitive value or it won't render properly
    ...
    return (
        <div className="m-2 grid grid-cols-6 md:grid-cols-12 bg-trf-400 rounded">
            <NavLink className=" sm:px-4 grid-col-start-1 md:col-start-2" to="/">
                <img className="m-2 content-start " src={homeLogo} alt="Home" />
            </NavLink>
            <NavLink className="px-4 col-start-4 md:col-start-9" to="/users/signin">
                <img className="m-2 content-start " src={signInLogo} alt="Sign In" />
            </NavLink>
            <NavLink className="px-4 col-start-5 md:col-start-10 col-span-2 relative" to="/cart">
                <img className="m-2 content-start" src={cartLogo} alt="Cart" />
